...
22:                                               ; preds = %22, %0
  ...
  %24 = phi double [ 0x3FF6A09E667A35E6, %0 ], [ %36, %22 ]
  %25 = phi double [ 0x3FE3C6EF37290DCB, %0 ], [ %40, %22 ]
  %26 = fmul double %24, 0x3FEFFFFE8830BB8A
  %27 = call double @llvm.fmuladd.f64(double %25, double 0x3FF000001AD7F29B, double %26)
  %28 = fmul double %27, 0xBEA77CF44765195F
  %29 = call double @llvm.fmuladd.f64(double %24, double 0x3FF000005087D7D0, double %28)
  %30 = and i32 %23, 6
  %31 = sitofp i32 %30 to double
  %32 = call double @llvm.fmuladd.f64(double %31, double 1.250000e-01, double %27)
  %33 = fmul double %29, 0x3FEFFFFE8830BB8A
  %34 = call double @llvm.fmuladd.f64(double %32, double 0x3FF000001AD7F29B, double %33)
  %35 = fmul double %34, 0xBEA77CF44765195F
  %36 = call double @llvm.fmuladd.f64(double %29, double 0x3FF000005087D7D0, double %35)
  %37 = and i32 %23, 6
  %38 = or disjoint i32 %37, 1
  %39 = sitofp i32 %38 to double
  %40 = call double @llvm.fmuladd.f64(double %39, double 1.250000e-01, double %34)
  %41 = add nuw nsw i32 %23, 2
  %42 = icmp eq i32 %41, 12000000
